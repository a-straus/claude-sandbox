...
TO ANSWER:
1. Add your response under the question's "Your answer:" line. That's it —
   leave the [PENDING] marker alone; the orchestrator notices the text and
   flips it to [ANSWERED] itself.
2. Save the file. Locally that's enough; in sync mode (ORCH_SYNC=1) you can
   edit in the GitHub web editor and commit — the loop pulls before every
   iteration.
